...
internal class MyScannerClientInteraction(
    ...
    private fun buildQuestionToAskCode(parameterInfo: ParameterInfo): String {
        ...
        var _question = "Enter authentication code"
        ...
        _question += "Phone number: ${codeInfo.phoneNumber}"
        _question += "Timeout: ${codeInfo.timeout} seconds"
